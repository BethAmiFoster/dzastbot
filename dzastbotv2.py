...
class MyClient(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content.startswith('//dzhelp') and message.channel.id !=660314906972651530:
           embedhelp=discord.Embed(title="Džastbot v2.122 help menu", description="Welcome to džastbot help menu, here is a small command/feature list:")
        ...
        if message.content.startswith('//changelog') and message.channel.id !=660314906972651530:
           ...
           embed.add_field(name="2.122 - //funny upd", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           ...
           embed.add_field(name="2.116 - im back baby", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.115 - smiley channel edits update", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.114 - moar sus pic", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.113 - pimp at sea update", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.111 - embeds update and bots blacklisted", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.109 - smiley channel", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.102 - added //megadrop", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.99-2.100 - more sus pics", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.98 - more triggers for sus pics", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.97 - pimps at sea update", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.96 - more sus pics", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.94 - added //beytah", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.92 - enabled smiley channel code", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.85 - 2.91 - working on smiley channel revival, although disabled (code works though) plus one bugfix for sus response", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.85 - changed //help to //dzhelp", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.84 - updated //help and //changelog textbox", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.83 - added //changelog command", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
           embed.add_field(name="2.82 - added more sus pics", value="CANT I JUST LEAVE THIS EMPTY", inline=False)
...
client = MyClient(status = discord.Status.idle, activity = discord.Game('v2.122; //dzhelp'))
client.run(TOKEN)
